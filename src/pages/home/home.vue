...
export default {
  ...
  data() {
    return {
      banners: [
        { title: '自然风光', icon: '🏞️', bg: 'linear-gradient(135deg, #ff8a80, #ffab91)' },
        { title: '美食推荐', icon: '🍜', bg: 'linear-gradient(135deg, #ff7043, #ffab40)' },
        { title: '今日特惠', icon: '🎉', bg: 'linear-gradient(135deg, #ec407a, #f48fb1)' },
      ],
      menuList: [
